  ...
  return (
      <div className={styles.container}>
        <Head>
          ...
          <link rel="icon" href="/Users/lucas/IdeaProjects/mine/abogadopro/src/public/favicon.ico"/>
        </Head>
        ...
        <main className={styles.main}>
          ...
          <div className={styles.grid}>
            ...
            >
              <h2>Describa su situación actual</h2>
              <div>
                <Formik
                    ...
                    onSubmit={(values, {setSubmitting, resetForm}) => {
                      ...
                      .catch(function (error) {
                        alert("Hubo un error al contactar, intente más tarde.");
                      });
                      resetForm();
                    }}
                >
                      ...
                      <Form>
                        ...
                        <div className="form-group">
                          ...
                          <Field name="type" as="select" className="form-select" required>
                            ...
                            <option value="Pensión alimenticia" selected>Pensión alimenticia</option>
